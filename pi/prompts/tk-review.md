---
description: Review a ticket using 4-role + lead reviewer pipeline
---
...
## Pre-execution Check
Ensure that `subagent` extension is installed (required for parallel role reviewers).
...
- Subagent extension not installed → Install Pi subagent extension
