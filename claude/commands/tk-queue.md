...
allowed-tools: Bash(tk:*), Bash(openspec:*), Read, Edit, Write
---

# /tk-queue $@

Parse flags (flags take precedence; positional supported for backward compatibility):
...
**STOP here. This command does not start work. Wait for `/tk-start`.**
