...
1. Show the change details: !`openspec show $ARGUMENTS`
2. Show the task list: !`cat openspec/changes/$ARGUMENTS/tasks.md`
...
- Suggested ticket chunks (3–8 items, with titles that could become tk tickets)
